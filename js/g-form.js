$(function() {
  $(".g-form").submit(function (event) {
    ...
    // let appLink = "https://script.google.com/macros/s/AKfycbwkf4mME4WpK9FYzNv7R0tE4QyAnZ3Lull1nBUAvxBeQ0IYDV2emeWs-DXGt0a_4lVc/exec";
    ...
    // Выводим ответ формы.
    formRespond.html(successRespond).css('color', '#42428E');
    formRespond.html(successRespond).css('padding-bottom', '20px');
    ...
    submitButton.prop('disabled', false);
      ...
      inp.style.paddingLeft="69px";

      const myEvent = new CustomEvent('form_submit');
...
const labels = document.querySelectorAll('.label-other');
if (labels) {
  labels.forEach(function(label) {
    const inp = label.querySelector('input');
    const input = label.querySelector('.input__item').querySelector('input');
